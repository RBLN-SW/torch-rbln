...
- **Keep PR descriptions concise** — Do not include implementation details, caveats about the dev environment (e.g. "CI cannot be verified locally"), internal caching strategies, or session URLs in PR descriptions. Focus on what changed and why. Put technical notes in code comments instead.
