...
Tests that broke after your change are yours to investigate. Compare base against head in a separate worktree with the same venv and pin, as `AGENTS.md` (Evidence) says — not by stashing or reverting in the tree you run from.
